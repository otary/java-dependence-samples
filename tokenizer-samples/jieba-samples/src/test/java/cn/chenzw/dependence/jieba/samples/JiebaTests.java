package cn.chenzw.dependence.jieba.samples;
...
public class JiebaTests {
    ...
    private static String seg(String text, JiebaSegmenter.SegMode segMode) {
    ...
    public void test() {
        ...
        map.put("INDEX", seg(article, JiebaSegmenter.SegMode.INDEX));
        map.put("SEARCH", seg(article, JiebaSegmenter.SegMode.SEARCH));
